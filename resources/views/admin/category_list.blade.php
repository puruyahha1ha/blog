...
@section('main')
    ...
    <a href="{{ route('admin.category_list.edit') }}" class="list_regist">商品カテゴリ登録</a>
    <form action="{{ route('admin.category_list') }}" method="get">
        {{-- 検索フォーム --}}
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 250px">商品カテゴリ大</th>
        ...
        <tbody>
            @foreach ($categories as $val)
                <tr>
                    ...
                    <th style="border-left:black solid 1px"><a href="{{ route('admin.category_list.edit', ['id' => $val->id]) }}"
                            style="text-decoration: none; color:blue">編集</a></th>
                    <th style="border-left:black solid 1px"><a href="{{ route('admin.category_list.detail', ['id' => $val->id]) }}"
